...
# We no longer use fixed positions.
SPAWN_MARGIN = 1.0       # How far from the wall they must spawn
MIN_SPAWN_DIST = 3.0     # Minimum distance between agents at spawn
...
MODEL_NAME = "pokemon_mappo_lidar_v2.pt"